...
r_motion_state2::r_motion_state2(size_t memory) :
...
r_motion_state2::~r_motion_state2() noexcept
{
}

r_nullable<r_motion_info> r_motion_state2::process(const r_image& argb_input)
{

    cv::Mat cv_image(argb_input.height, argb_input.width, CV_8UC4, const_cast<unsigned char*>(argb_input.data.data()));
